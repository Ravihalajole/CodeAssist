...
object CommandExecutor {
    ...
    private fun handleListDir(rootDir: File, relativePath: String): ExecutionResult {
        ...
        if (!isPathSafe(rootDir, targetDir)) return ExecutionResult(false, "Security Error: Path traversal attempt blocked.")
    ...
    private fun handleDeleteFile(rootDir: File, relativePath: String): ExecutionResult {
        ...
        return if (targetFile.exists()) {
            if (targetFile.isFile) {
                targetFile.delete()
                ExecutionResult(true, "Deleted file: $relativePath")
            } else {
